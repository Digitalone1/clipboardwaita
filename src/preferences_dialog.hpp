...
#define CBWAITA_TYPE_PREFERENCES_DIALOG (preferences_dialog_get_type())

G_DECLARE_FINAL_TYPE(PreferencesDialog, preferences_dialog, CBWAITA,
                     PREFERENCES_DIALOG, AdwPreferencesDialog)
